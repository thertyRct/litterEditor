				...
				tabs: [
					// TAB 1: PIPETTE
					{
						...
						widgets: [
							...
							<SpinnerDesc>{ name: xPositionSpinner, type: "spinner", x: 90, y: 135, width: 70, height: widgetLineHeight, text: " ", isDisabled: true, onIncrement: () => this.increase(xPositionSpinner, "x"), onDecrement: () => this.decrease(xPositionSpinner, "x"), onClick: spinnerTextInput("X Position", "Enter a value:", () => idLitter?.x ?? 0, -Infinity, Infinity, (n) => { if (idLitter) { idLitter.x = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(xPositionSpinner).text = n.toString(); ui.getWindow(windowId).findWidget<ViewportWidget>(litterViewport).viewport.moveTo(idLitter); } }), },
							<LabelWidget>{ name: yPositionLabel, type: "label", x: 20, y: 153, width: 125, height: widgetLineHeight, text: "Y-Position", isDisabled: true, },
							<SpinnerDesc>{ name: yPositionSpinner, type: "spinner", x: 90, y: 153, width: 70, height: widgetLineHeight, text: " ", isDisabled: true, onIncrement: () => this.increase(yPositionSpinner, "y"), onDecrement: () => this.decrease(yPositionSpinner, "y"), onClick: spinnerTextInput("Y Position", "Enter a value:", () => idLitter?.y ?? 0, -Infinity, Infinity, (n) => { if (idLitter) { idLitter.y = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(yPositionSpinner).text = n.toString(); ui.getWindow(windowId).findWidget<ViewportWidget>(litterViewport).viewport.moveTo(idLitter); } }), },
							<LabelWidget>{ name: zPositionLabel, type: "label", x: 20, y: 171, width: 125, height: widgetLineHeight, text: "Z-Position", isDisabled: true, },
							<SpinnerDesc>{ name: zPositionSpinner, type: "spinner", x: 90, y: 171, width: 70, height: widgetLineHeight, text: " ", isDisabled: true, onIncrement: () => this.increase(zPositionSpinner, "z"), onDecrement: () => this.decrease(zPositionSpinner, "z"), onClick: spinnerTextInput("Z Position", "Enter a value:", () => idLitter?.z ?? 0, -Infinity, Infinity, (n) => { if (idLitter) { idLitter.z = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(zPositionSpinner).text = n.toString(); ui.getWindow(windowId).findWidget<ViewportWidget>(litterViewport).viewport.moveTo(idLitter); } }), },
					...
					// TAB 3: TRACK DISTRIBUTOR
					{
						...
						widgets: [
							...
							<SpinnerDesc>{ name: trackDistCountSpinner, type: "spinner", x: 90, y: 92, width: 70, height: widgetLineHeight, text: "4", onIncrement: () => onTrackDistCountChange(1), onDecrement: () => onTrackDistCountChange(-1), onClick: spinnerTextInput("Num. Litter", "Enter a value (1-8):", () => trackDistCount, 1, 8, (n) => { trackDistCount = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(trackDistCountSpinner).text = n.toString(); }), },
							...
							<SpinnerDesc>{ name: trackDistOffsetSpinner, type: "spinner", x: 90, y: 132, width: 70, height: widgetLineHeight, text: "0", onIncrement: () => onTrackDistOffsetChange(1), onDecrement: () => onTrackDistOffsetChange(-1), onClick: spinnerTextInput("Z Offset", "Enter a value:", () => trackDistZOffset, -Infinity, Infinity, (n) => { trackDistZOffset = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(trackDistOffsetSpinner).text = n.toString(); }), },
					...
					// TAB 4: DIAGONAL TEXT
					{
						...
						widgets: [
							...
							<SpinnerDesc>{ name: diagTextXSpacingSpinner, type: "spinner", x: 80, y: 140, width: 55, height: widgetLineHeight, text: "2", onIncrement: () => { diagTextXSpacing = Math.min(32, diagTextXSpacing + 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextXSpacingSpinner).text = diagTextXSpacing.toString(); }, onDecrement: () => { diagTextXSpacing = Math.max(0, diagTextXSpacing - 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextXSpacingSpinner).text = diagTextXSpacing.toString(); }, onClick: spinnerTextInput("X Spacing", "Enter a value (0-32):", () => diagTextXSpacing, 0, 32, (n) => { diagTextXSpacing = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextXSpacingSpinner).text = n.toString(); }), },
							<LabelWidget>{ type: "label", x: 140, y: 140, width: 55, height: widgetLineHeight, text: "Y Spacing", isDisabled: true, },
							<SpinnerDesc>{ name: diagTextYSpacingSpinner, type: "spinner", x: 198, y: 140, width: 45, height: widgetLineHeight, text: "2", onIncrement: () => { diagTextYSpacing = Math.min(32, diagTextYSpacing + 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextYSpacingSpinner).text = diagTextYSpacing.toString(); }, onDecrement: () => { diagTextYSpacing = Math.max(0, diagTextYSpacing - 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextYSpacingSpinner).text = diagTextYSpacing.toString(); }, onClick: spinnerTextInput("Y Spacing", "Enter a value (0-32):", () => diagTextYSpacing, 0, 32, (n) => { diagTextYSpacing = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextYSpacingSpinner).text = n.toString(); }), },
							
							<LabelWidget>{ type: "label", x: 15, y: 156, width: 62, height: widgetLineHeight, text: "Z Spacing", isDisabled: true, },
							<SpinnerDesc>{ name: diagTextZSpacingSpinner, type: "spinner", x: 80, y: 156, width: 55, height: widgetLineHeight, text: "2", onIncrement: () => { diagTextZSpacing = Math.min(32, diagTextZSpacing + 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextZSpacingSpinner).text = diagTextZSpacing.toString(); }, onDecrement: () => { diagTextZSpacing = Math.max(0, diagTextZSpacing - 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextZSpacingSpinner).text = diagTextZSpacing.toString(); }, onClick: spinnerTextInput("Z Spacing", "Enter a value (0-32):", () => diagTextZSpacing, 0, 32, (n) => { diagTextZSpacing = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextZSpacingSpinner).text = n.toString(); }), },
							<LabelWidget>{ type: "label", x: 140, y: 156, width: 55, height: widgetLineHeight, text: "Kerning", isDisabled: true, },
							<SpinnerDesc>{ name: diagTextKerningSpinner, type: "spinner", x: 198, y: 156, width: 45, height: widgetLineHeight, text: "2", onIncrement: () => { diagTextKerning = Math.min(32, diagTextKerning + 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextKerningSpinner).text = diagTextKerning.toString(); }, onDecrement: () => { diagTextKerning = Math.max(0, diagTextKerning - 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextKerningSpinner).text = diagTextKerning.toString(); }, onClick: spinnerTextInput("Kerning", "Enter a value (0-32):", () => diagTextKerning, 0, 32, (n) => { diagTextKerning = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextKerningSpinner).text = n.toString(); }), },
							
							<LabelWidget>{ type: "label", x: 15, y: 172, width: 62, height: widgetLineHeight, text: "X Offset", isDisabled: true, },
							<SpinnerDesc>{ name: diagTextXOffsetSpinner, type: "spinner", x: 80, y: 172, width: 55, height: widgetLineHeight, text: "0", onIncrement: () => { diagTextXOffset = Math.min(128, diagTextXOffset + 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextXOffsetSpinner).text = diagTextXOffset.toString(); }, onDecrement: () => { diagTextXOffset = Math.max(-128, diagTextXOffset - 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextXOffsetSpinner).text = diagTextXOffset.toString(); }, onClick: spinnerTextInput("X Offset", "Enter a value (-128 to 128):", () => diagTextXOffset, -128, 128, (n) => { diagTextXOffset = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextXOffsetSpinner).text = n.toString(); }), },
							<LabelWidget>{ type: "label", x: 140, y: 172, width: 55, height: widgetLineHeight, text: "Y Offset", isDisabled: true, },
							<SpinnerDesc>{ name: diagTextYOffsetSpinner, type: "spinner", x: 198, y: 172, width: 45, height: widgetLineHeight, text: "0", onIncrement: () => { diagTextYOffset = Math.min(128, diagTextYOffset + 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextYOffsetSpinner).text = diagTextYOffset.toString(); }, onDecrement: () => { diagTextYOffset = Math.max(-128, diagTextYOffset - 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextYOffsetSpinner).text = diagTextYOffset.toString(); }, onClick: spinnerTextInput("Y Offset", "Enter a value (-128 to 128):", () => diagTextYOffset, -128, 128, (n) => { diagTextYOffset = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextYOffsetSpinner).text = n.toString(); }), },
							
							<LabelWidget>{ type: "label", x: 15, y: 188, width: 62, height: widgetLineHeight, text: "Z Offset", isDisabled: true, },
							<SpinnerDesc>{ name: diagTextZOffsetSpinner, type: "spinner", x: 80, y: 188, width: 55, height: widgetLineHeight, text: "0", onIncrement: () => { diagTextZOffset = diagTextZOffset + 1; ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextZOffsetSpinner).text = diagTextZOffset.toString(); }, onDecrement: () => { diagTextZOffset = diagTextZOffset - 1; ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextZOffsetSpinner).text = diagTextZOffset.toString(); }, onClick: spinnerTextInput("Z Offset", "Enter a value:", () => diagTextZOffset, -Infinity, Infinity, (n) => { diagTextZOffset = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextZOffsetSpinner).text = n.toString(); }), },
							<LabelWidget>{ type: "label", x: 140, y: 188, width: 55, height: widgetLineHeight, text: "Bias", isDisabled: true, },
							<SpinnerDesc>{ name: diagTextBiasSpinner, type: "spinner", x: 198, y: 188, width: 45, height: widgetLineHeight, text: "0", onIncrement: () => { diagTextBias = Math.min(128, diagTextBias + 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextBiasSpinner).text = diagTextBias.toString(); }, onDecrement: () => { diagTextBias = Math.max(-128, diagTextBias - 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextBiasSpinner).text = diagTextBias.toString(); }, onClick: spinnerTextInput("Bias", "Enter a value (-128 to 128):", () => diagTextBias, -128, 128, (n) => { diagTextBias = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(diagTextBiasSpinner).text = n.toString(); }), },
					...
					// TAB 5: IMAGE PRINTER
					{
						...
						widgets: [
							...
							<SpinnerDesc>{ name: imgPrintScaleSpinner, type: "spinner", x: 80, y: 125, width: 55, height: widgetLineHeight, text: "3", onIncrement: () => { imgPrintScale = Math.min(32, imgPrintScale + 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintScaleSpinner).text = imgPrintScale.toString(); }, onDecrement: () => { imgPrintScale = Math.max(1, imgPrintScale - 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintScaleSpinner).text = imgPrintScale.toString(); }, onClick: spinnerTextInput("Scale", "Enter a value (1-32):", () => imgPrintScale, 1, 32, (n) => { imgPrintScale = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintScaleSpinner).text = n.toString(); }), },
							...
							<SpinnerDesc>{ name: imgPrintXOffsetSpinner, type: "spinner", x: 80, y: 145, width: 55, height: widgetLineHeight, text: "0", onIncrement: () => { imgPrintXOffset = Math.min(128, imgPrintXOffset + 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintXOffsetSpinner).text = imgPrintXOffset.toString(); }, onDecrement: () => { imgPrintXOffset = Math.max(-128, imgPrintXOffset - 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintXOffsetSpinner).text = imgPrintXOffset.toString(); }, onClick: spinnerTextInput("X Offset", "Enter a value (-128 to 128):", () => imgPrintXOffset, -128, 128, (n) => { imgPrintXOffset = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintXOffsetSpinner).text = n.toString(); }), },
							
							<LabelWidget>{ type: "label", x: 140, y: 145, width: 55, height: widgetLineHeight, text: "Y Offset", isDisabled: true, },
							<SpinnerDesc>{ name: imgPrintYOffsetSpinner, type: "spinner", x: 188, y: 145, width: 55, height: widgetLineHeight, text: "0", onIncrement: () => { imgPrintYOffset = Math.min(128, imgPrintYOffset + 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintYOffsetSpinner).text = imgPrintYOffset.toString(); }, onDecrement: () => { imgPrintYOffset = Math.max(-128, imgPrintYOffset - 1); ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintYOffsetSpinner).text = imgPrintYOffset.toString(); }, onClick: spinnerTextInput("Y Offset", "Enter a value (-128 to 128):", () => imgPrintYOffset, -128, 128, (n) => { imgPrintYOffset = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintYOffsetSpinner).text = n.toString(); }), },
							
							<LabelWidget>{ type: "label", x: 15, y: 165, width: 62, height: widgetLineHeight, text: "Z Offset", isDisabled: true, },
							<SpinnerDesc>{ name: imgPrintZOffsetSpinner, type: "spinner", x: 80, y: 165, width: 55, height: widgetLineHeight, text: "0", onIncrement: () => { imgPrintZOffset = imgPrintZOffset + 1; ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintZOffsetSpinner).text = imgPrintZOffset.toString(); }, onDecrement: () => { imgPrintZOffset = imgPrintZOffset - 1; ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintZOffsetSpinner).text = imgPrintZOffset.toString(); }, onClick: spinnerTextInput("Z Offset", "Enter a value:", () => imgPrintZOffset, -Infinity, Infinity, (n) => { imgPrintZOffset = n; ui.getWindow(windowId).findWidget<SpinnerWidget>(imgPrintZOffsetSpinner).text = n.toString(); }), },
						],
					},
					// TAB 6: INFO
					{
...
function onTrackDistOffsetChange(delta: number): void {
	trackDistZOffset = trackDistZOffset + delta;
